...
const radioStepConfigs = {
  "roofing-type": { title: "What type of roofing service do you need?", field: "roofingType", event: "types", options: [
    { id: "Roof Replace", name: "Replace" }, { id: "Roof Repair", name: "Repair" }, { id: "New Construction", name: "Install" }
  ]},
  "material": { title: "What type of roofing material are you looking for?", field: "material", event: "services", options: [
  ...
  "window-type": { title: "What is the nature of your windows project?", field: "windowType", event: "types", options: [
    { id: "Install", name: "Install" }, { id: "Repair", name: "Repair" }
  ]},
  "window-count": { title: "How many windows are involved?", field: "windowCount", event: "services", options: [
    { id: "1", name: "1" }, { id: "2", name: "2" }, { id: "3-5", name: "3-5" }, { id: "6-9", name: "6-9" }
  ]},
  "solar-type": { title: "What type of solar solution do you need?", field: "solarType", event: "types", options: [
    { id: "solarInstall", name: "Solar Install" }, { id: "solarRepair", name: "Solar Repair" }, { id: "solarUpgrade", name: "Solar Upgrade" }
  ]},
  "roof-size": { title: "What is your average monthly electric bill?", field: "electricBill", event: "services", options: [
    { id: "Under $100", name: "Under $100" }, { id: "$100 - $200", name: "$100 - $200" },
    { id: "$200 - $300", name: "$200 - $300" }, { id: "$300+", name: "$300+" }
  ]},
  "bathroom-wall": { title: "Need to remove or add walls for bath remodel?", field: "bathwallType", event: "types", options: [
    { id: "Yes", name: "Yes" }, { id: "No", name: "No" }
  ]},
  "gutter-type": { title: "What type of gutter service do you need?", field: "gutterType", event: "types", options: [
    { id: "Install", name: "Install" }, { id: "Repair", name: "Repair" }
  ]},
  "gutter-material": { title: "Select Gutter Material", field: "gutterMaterial", event: "services", options: [
  ...
  "tub-reason": { title: "What's the biggest reason you are considering a walk-in tub?", field: "tubReason", event: "types", options: [
...
function submitRadioStep() {
  ...
  var stepName = store.getCurrentStepName();
  var config = radioStepConfigs[stepName];
...
var upsellServiceData = {
  roof:    { name:"Roofing",        key:"roof",    image:"images/roofing_services.webp",      desc:"Premium roofing solutions for any home",    path:"/get-quotes/roof" },
  solar:   { name:"Solar Energy",   key:"solar",   image:"images/Solar.webp",                 desc:"Save on energy costs with clean solar power",path:"/get-quotes/solar" },
  windows: { name:"Windows",        key:"windows", image:"images/window_services.webp",       desc:"Modern windows that improve comfort",       path:"/get-quotes/windows" },
  gutter:  { name:"Gutters",        key:"gutter",  image:"images/gutter_services.webp",       desc:"Quality gutter systems to protect your home",path:"/get-quotes/gutter" },
  bath:    { name:"Bath Remodeling", key:"bath",    image:"images/walkin_tub_services.png",    desc:"Modern bathroom renovations for comfort",   path:"/get-quotes/bath" },
  shower:  { name:"Walk-in Shower", key:"shower",  image:"images/walkin_shower_services.png", desc:"Modern, accessible shower solutions",       path:"/get-quotes/shower" },
};
