...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-r from-blue-950 to-blue-800 flex flex-col justify-between lg:flex-row lg:items-center overflow-hidden">
      ...
      <div className="relative w-full h-[35vh] xs:h-[45vh] xl:h-[105vh] mm:h-[40vh] md:w-[90%] md:mx-auto tab:w-[85%] lg:w-3/5 lg:h-screen flex items-center justify-center lg:justify-end xl:pr-5 md:pb-5 xs:pb-2">
        <img
          src={img}
