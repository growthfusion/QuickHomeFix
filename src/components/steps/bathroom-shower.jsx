...
const ShowerOptionCard = ({ id, image, title, isSelected, onSelect, questionText, answerText }) => {
...
const bathshowerTypes = [
  { id: "newShower", name: "Install New Shower", img: shower, questionText: "Do you need a shower installation or upgrade?", answerText: "Install New Shower" },
  { id: "upgradeShower", name: "Upgrade Shower", img: upgrade, questionText: "Do you need a shower installation or upgrade?", answerText: "Upgrade Shower" },
  { id: "nochange", name: "No Change",  img: block, questionText: "Do you need a shower installation or upgrade?", answerText: "No Change" },
];
