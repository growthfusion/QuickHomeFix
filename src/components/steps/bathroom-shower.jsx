...
const bathshowerTypes = [
  { id: "newShower", name: "Install New Shower", questionText: "Do you need a shower installation or upgrade?", answerText: "Install New Shower" },
  { id: "upgradeShower", name: "Upgrade Shower", questionText: "Do you need a shower installation or upgrade?", answerText: "Upgrade Shower" },
  { id: "nochange", name: "No Change", questionText: "Do you need a shower installation or upgrade?", answerText: "No Change" },
];
      ...
      <Card className="w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6 sm:p-8">
          <div className="text-center mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900">Do you need a shower installation or upgrade?</h2>
          </div>
          <div className="border border-gray-200 rounded-xl overflow-hidden mb-6">
            {bathshowerTypes.map((type, idx) => (
              <button
                key={type.id}
                type="button"
                onClick={() => handleTypeSelect(type.id, type.questionText, type.answerText)}
                className={`w-full flex items-center gap-3 px-5 py-4 text-left transition-colors ${
                  idx !== bathshowerTypes.length - 1 ? "border-b border-gray-200" : ""
