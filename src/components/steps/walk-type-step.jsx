...
const walkinTypes = [
  { id: "replace", name: "Replace", questionText: "What type of Walk-In Shower", answerText: "Replace" },
  { id: "install", name: "Install", questionText: "What type of Walk-In Shower", answerText: "Install" },
  { id: "repair", name: "Repair", questionText: "What type of Walk-In Shower", answerText: "Repair" },
];
      ...
      <Card className="w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6 sm:p-8">
          <div className="text-center mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900">What type of Walk-In Shower</h2>
          </div>
            ...
            {walkinTypes.map((type, idx) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-5 py-4 text-left transition-colors ${
                  idx !== walkinTypes.length - 1 ? "border-b border-gray-200" : ""
