      ...
      <Card className="mx-auto max-w-4xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg shadow-xl border border-gray-200/60 dark:border-gray-700/60 overflow-hidden">
        <CardContent className="p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">What type of gutter service do you need?</h2>
          </div>
            ...
            {gutterTypes.map((type, index) => (
              ...
              >
                <div
                  ...
                  onClick={() => updateFormData("gutterType", type.id)}
                >
                  <div className={`absolute inset-0 ${
                    formData.gutterType === type.id
