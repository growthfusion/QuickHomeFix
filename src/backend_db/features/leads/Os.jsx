...
const tableHeaders = [
  'OS', 'VISITS', 'CTR, %', 'CLICKS', 'CR, %', 'EMAILS', 'LEADS', 'SOLD', '%', 'APPTS', '%', 'UPSELLS', 'SOLD', '%', 'UPSELL_RATE, %', 'PPC', 'SOLD', '%', 'PPC_RATE, %', 'TOTAL REVENUE, $', 'LEADS, $', 'FB FORM, $', 'UPSELLS, $', 'PPC, $', 'REPOSTS, $', 'ADJUSTMENT, $', 'AVG PER LEAD, $', 'AVG PER SOLD, $', 'EPC, $', 'EPV, $'
];
