...
// Define presets in a shared location so both components can access them.
const PRESETS = [
...
// Utility to format the date range for display
...
// Main component that toggles the DatePicker
function DatePickerToggle() {
  // The main state now includes a 'key' to track the selected preset
